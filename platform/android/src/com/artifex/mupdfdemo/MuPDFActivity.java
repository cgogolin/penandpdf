...
//	private EditText     mSearchText;
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		mAlertBuilder = new AlertDialog.Builder(this);
                    ...
                    //Only the core suvives configureation changes!!!
		if (core == null) {
            ...
            case Main:
                ...
                else
                {
                    if (mShareActionProvider == null)
                    {
                        ...
                        shareIntent.setType("*/*");
                        shareIntent.putExtra(Intent.EXTRA_STREAM, Uri.fromFile(new File(core.getPath()))); //Causes crash on orientation change
...
//                                mTopBarMode = TopBarMode.Main;
		...
		// mFilenameView.setText(core.getFileName());
